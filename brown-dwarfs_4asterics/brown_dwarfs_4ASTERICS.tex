...
\verb|    |
\textquotesingle
\verb|in=http://vizier.u-strasbg.fr/viz-bin/votable/-A?-source=II/246&-out.| \\
\verb|        max=unlimited&verb=3&RA=127.5&DEC=+1.5&SR=0.2333333|
\textquotesingle
\verb| \|\\
\verb|    out=2mass.xml| \\
...
\verb|    |
\textquotesingle
\verb|in=http://vizier.u-strasbg.fr/viz-bin/votable?-source=V/139| \\
\verb|        &-out.max=unlimited&-c=127.5+1.5&-c.rd=0.2333333|
\textquotesingle
\verb| \| \\
