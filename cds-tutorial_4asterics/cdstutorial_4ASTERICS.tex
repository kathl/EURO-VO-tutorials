...
be found here: 
\hyperref[http://simbad.u-strasbg.fr/simbad/sim-display?data=otypes]{\textcolor{blue}{http://simbad.u-strasbg.fr/simbad/sim-display?data=otypes}}.
...
bring out the most important ones. 
    \item Follow the link to the \simbad\ entry of the Antennae galaxies 
...
machine. To do so use the following command line: ` java -Xmx1024m -jar 
Aladin.jar '
...
Infrared $\rightarrow$ 2MASS} and load the 2MASS colour image. Use the 
opacity slider \includegraphics[width=0.035  
\textwidth]{../images/aladin_button_opacity.png} next to the 2MASS plane in the 
image stack to change the opacity of the 2MASS image and to compare it to the 
DSS image. 
%In order to view a RGB image of the 2MASS data you have two options:
%    \begin{enumerate}
%        \item Load the \textbf{2MASS J, H and K} bands images in the 
%        \textsc{Data Tree} by clicking on their entry, ticking the box 
%        \textbf{progressive} in the pop-up window and then clicking 
%        \textbf{Load} (see Figure~\ref{fig:aladin_load_2mass}). Then construct 
%a color image with the \textbf{rgb} tool \includegraphics[width=0.03  
%        \textwidth]{../images/rgb.jpg}.
%        \item Load the 2MASS colour image. 
%    \end{enumerate} 
...
images in a number of different ways:
    \begin{itemize}
        ...
        \textwidth]{../images/aladin_button_opacity.png} as before. Note 
...
\hyperref[http://aladin.u-strasbg.fr/hips/]{\textcolor{blue}{http://aladin.u-strasbg.fr/hips/}},
...
would like to have an overview of the HiPS exist have a look at 
\hyperref[https://aladin.u-strasbg.fr/hips/list]{\textcolor{blue}{https://aladin.u-strasbg.fr/hips/list}}
...
\includegraphics[width=0.035\textwidth]{../images/aladin_button_moc.png} right 
of the main viewing window. 
...
can do this in one of the two ways:
    \begin{itemize}
...
sources by extracting small images from the SDSS survey:
    ...
    \begin{itemize}
        ...
        \textbf{grid} \includegraphics[width=0.04\textwidth]
